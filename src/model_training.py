...
class ModelTraining:
    def __init__(self,train_file_path,test_file_path,model_output_path):
    ...
    def load_and_split_data(self):
        try:
            logger.info(f"Loading data from {self.train_file_path}")
            train_df = load_data(self.train_file_path)

            logger.info(f"Loading data from {self.test_file_path}")
    ...
    def train_lgbm(self,X_train,y_train):
        try:
            ...
            logger.info("Started Our Hyparparameter tuning")
            ...
            logger.info("Started Our Hyparparameter tuning")
            #logger.info("started our model training")
    ...
    def run(self):
        ...
        logger.info("Completed our Model Training pipeline")
